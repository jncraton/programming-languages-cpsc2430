...
- Can be processed by a simple finite auotmaton
...
![DFA to match binary numbers that are multiple of 3](https://upload.wikimedia.org/wikipedia/commons/9/94/DFA_example_multiplies_of_3.svg)
